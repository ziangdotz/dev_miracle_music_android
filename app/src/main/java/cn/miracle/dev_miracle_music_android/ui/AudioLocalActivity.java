...
public class AudioLocalActivity extends AppCompatActivity implements View.OnClickListener, MediaPlayer.OnCompletionListener {
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.relative_layout_retry) {
        ...
        } else if (id == R.id.relative_layout_position) {
            mAudioLocalRecyclerViewLinearLayoutManager.scrollToPositionWithOffset(currPositionInPlaying, 0);
        } else if (id == R.id.relative_layout_in_playing) {
        } else if (id == R.id.relative_layout_info_in_playing) {
        } else if (id == R.id.textview_prev_in_playing) {
        ...
        } else if (id == R.id.textview_play_or_pause_in_playing) {
            if (currPositionInPlaying != -1) {
        ...
        } else if (id == R.id.textview_next_in_playing) {
            if (currPositionInPlaying != -1) {
